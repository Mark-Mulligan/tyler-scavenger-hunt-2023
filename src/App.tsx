      ...
      <Routes>
        ...
        <Route
          ...
          element={
            <Question
              ...
              answer={['invisible']}
              hint="The habitat sits outside Kilwins and Liberation Coffee Co. and changes color at night. Read any information around it's border"
              next="/question7"
        ...
        <Route
          ...
          element={
            <Question
              title="Question 7"
              riddle="Which set of buildings has painted walls of blue and a cowboy riding into the sunset?"
              answer={['the homestead', 'homestead']}
              hint="You can find one next to the amphitheater stage"
              next="/question8"
        ...
        <Route
          ...
          element={
            <Question
              title="Question 8"
              riddle="How many sport figures came out to watch Pauline's show on the amphitheater stage? (enter a number)"
              answer={['4']}
        ...
        <Route
          ...
          element={
            <Question
              ...
              answer={['bench', 'a bench', 'the bench']}
        ...
        <Route
          ...
          element={
            <Question
              ...
              answer={['the kaleidoscope', 'kaleidoscope']}
        ...
        <Route
          ...
          element={
            <Question
              ...
              answer={['telephone booth', 'a telephone booth', 'the telephone booth']}
        ...
        <Route
          ...
          element={
            <Question
              ...
              hint="The next clue will not be through the tunnel. They have cocktails in their kitchen"
              next="/question14"
        ...
        <Route
          ...
          element={
            <Question
              ...
              answer={['truck yard', 'the truck yard']}
